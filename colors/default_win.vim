...
hi  Statement    gui=none      guifg=#74b024     guibg=NONE
...
hi StatuslineGreyGreen cterm=none    ctermfg=black  ctermbg=cyan    guibg=#cdcd7f guifg=black
hi StatuslineRed       cterm=none    ctermbg=white  ctermfg=yellow  guibg=#bd935f guifg=white
hi StatuslineSomething cterm=reverse ctermfg=white  ctermbg=darkred guibg=#bbcd99 guifg=black
hi StatuslinePath      cterm=none    ctermfg=white  ctermbg=green   guibg=#bbcd99 guifg=black
hi StatuslineFileName  cterm=none    ctermfg=white  ctermbg=blue    guibg=#ddefaa guifg=black
hi StatuslineFileType  cterm=bold    ctermbg=white  ctermfg=black   guibg=#cdb37f guifg=black
hi StatuslineFileEnc   cterm=none    ctermfg=white  ctermbg=yellow  guibg=#aa0000 guifg=white
