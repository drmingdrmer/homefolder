...
hi  Normal       gui=none      guifg=#e4e4e4     guibg=#141414
...
hi  Function     gui=none      guifg=#d0a3a3     guibg=NONE
...
hi  Type         gui=none      guifg=#6bc4a8     guibg=NONE
hi  Visual       gui=none      guifg=NONE        guibg=#303040
hi  Folded       gui=none      guifg=#8790b4     guibg=NONE
hi  Operator     gui=none      guifg=#91aac7     guibg=NONE
hi  Number       gui=none      guifg=#c8699d     guibg=#181818
hi  Comment      gui=none      guifg=#7c93ff     guibg=NONE
...
hi  String       gui=none      guifg=#719b71     guibg=#000000
