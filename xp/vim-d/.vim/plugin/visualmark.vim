...
" if &bg == "dark"
"  highlight SignTxtColor ctermfg=white ctermbg=blue guibg=#8fd480
"  highlight SignColor ctermfg=white ctermbg=blue guifg=white guibg=RoyalBlue3
" else
"  highlight SignTxtColor ctermfg=white ctermbg=blue guibg=#ffd480
"  highlight SignColor ctermfg=none ctermbg=blue guibg=#ffd480 
" endif

" ---------------------------------------------------------------------
"  Public Interface:
if !hasmapto('<Plug>Vm_toggle_sign')
  map <unique> ,s <Plug>Vm_toggle_sign
...
"  call Dfunc("Vm_place_sign()")
  ...
  exe 'sign define SignSymbol linehl=SignTxtColor texthl=SignColor text=>>'
