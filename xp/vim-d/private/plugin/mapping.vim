...
fun! s:DoMap() "{{{
    let mapping = [
          ...
          \ [ 'nmap', ",2",                   "<Plug>buffer:to2" ],
          \ [ 'nmap', ",3",                   "<Plug>buffer:to3" ],
          \ [ 'nmap', ",4",                   "<Plug>buffer:to4" ],
          \ [ 'nmap', ",5",                   "<Plug>buffer:to5" ],
          \ [ 'nmap', ",6",                   "<Plug>buffer:to6" ],
          \ [ 'nmap', ",7",                   "<Plug>buffer:to7" ],
          \ [ 'nmap', ",8",                   "<Plug>buffer:to8" ],
          ...
          \ [ 'nmap', "<M-E>",                "<Plug>edit:error_next" ],
          \ [ 'nmap', "<M-I>",                "<Plug>nav:tab_move_forward" ],
          \ [ 'nmap', "<M-R>",                "<Plug>edit:error_prev" ],
