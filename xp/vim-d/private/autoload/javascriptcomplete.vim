...
function! javascriptcomplete#CompleteJS(findstart, base)
  if a:findstart
	...
	let properties = ['decodeURI', 'decodeURIComponent', 'encodeURI', 'encodeURIComponent',
				...
				\'assertNaN', 'assertNotNaN', 'assertObjectEquals', 'assertEvaluatesToTrue', 
				\'assertEvaluatesToFalse', 'assertHTMLEquals', 'assertHashEquals', 
				\'assertRoughlyEquals', 'assertContains', 
				\'assertError', 'assertNotError'] "assertion
	...
	for i in range(len(menu))
        ...
        let final_menu = s:CreateHead(final_menu)
        let g:fm = final_menu
        " echo g:fm
...
function! s:CreateHead(lst)
  ...
  if las > 0
    ...
    let i=0
    while strpart(_1w, i, 1) == strpart(_2w, i, 1) && i<_1l && i<_2l
      let i = i + 1
    endwhile
    let lst=[strpart(_1w, 0, i)] + lst
  endif
  return lst
endfunction
