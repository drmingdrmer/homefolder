...
call XPTemplate('.e',  'S3_ERR_`x^ChooseStr("ERR", "EOF", "BUF_OVERFLOW", "BUF_NOT_ENOUGH", "NUM_OVERFLOW", "OUTOFMEM", "CHKSUM", "INVALID_ARG", "INVALID_STATE", "NOTFOUND", "DUP", "IO", "INITTWICE", "INDEX_OUT_OF_RANGE", "TIMEOUT", "NOT_SUPPORTED", "SOCKET_FAIL", "AGAIN")^')
