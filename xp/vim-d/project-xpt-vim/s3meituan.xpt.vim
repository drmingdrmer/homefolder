...
call XPTemplate('.e',  'S3_ERR_`x^ChooseStr("ERR", "EOF", "BUF_OVERFLOW", "BUF_NOT_ENOUGH", "NUM_OVERFLOW", "OUT_OF_MEM", "CHKSUM", "EXIST", "INVALID_ARG", "INVALID_STATE", "NOT_FOUND", "DUP", "IO", "INIT_TWICE", "INDEX_OUT_OF_RANGE", "TIMEOUT", "NOT_SUPPORTED", "SOCKET_FAIL", "AGAIN")^')
...
call XPTemplate('.mbui', 's3_must_uninited(`x^, `S3_ERR_INIT_TWICE^);')
