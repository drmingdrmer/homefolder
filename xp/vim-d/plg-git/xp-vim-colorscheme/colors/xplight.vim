...
hi  Normal       gui=none      guifg=#c4c4c4     guibg=#202020

hi  Define       gui=none      guifg=#cda869     guibg=NONE
hi  Character    gui=none      guifg=#a0576a     guibg=NONE
hi  Constant     gui=none      guifg=#d98576     guibg=NONE
hi  Todo         gui=none      guifg=#000000     guibg=#d07c16
hi  Label        gui=none      guifg=#ffffff     guibg=#4c4646
hi  Identifier   gui=none      guifg=#bd905d     guibg=NONE
hi  Keyword      gui=none      guifg=#ffb194
hi  Function     gui=none      guifg=#90bcf5     guibg=NONE
hi  Question     gui=none      guifg=#82c000     guibg=NONE
hi  Tag          gui=none      guifg=#7b9f63     guibg=NONE
hi  Statement    gui=none      guifg=#91cb71     guibg=NONE
...
hi  Comment      gui=none      guifg=#666168     guibg=NONE
...
hi  PreProc      gui=none      guifg=#8e8eff     guibg=#181818
hi  String       gui=none      guifg=#de87fb     guibg=NONE
...
hi  LineNr       gui=none      guifg=#333334     guibg=#080808
...
hi TabLineFill gui=none guifg=#888888 guibg=#333333
hi TabLine     gui=none guifg=#bbbbbb guibg=#555555
hi TabLineSel  gui=none guifg=black   guibg=#aadd55


call hiemp#EmphasizeHLs(-30, [
            \'Character',
            \'Comment',
            \'Constant',
            \'Cursor',
...
hi StatuslineCurLine   cterm=none    ctermbg=white  ctermfg=yellow  gui=none guibg=#353023 guifg=white
